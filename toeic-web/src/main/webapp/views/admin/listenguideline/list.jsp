...
<c:url var="requestUrl" value="/admin-guideline-listen-list"/>
<c:url value="/admin-guideline-listen-edit" var="listenGuidelineEditUrl">
    <c:param name="urlType" value="url_edit"/>
</c:url>
<c:url var="formUrl" value="/admin-guideline-listen-list"/>
<html>
<head>
